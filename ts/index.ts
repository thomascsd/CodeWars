import { G964 } from './phone-directory.js';
...
let ret = G964.phone(dr, '48-421-674-8974');
console.log(ret == 'Phone => 48-421-674-8974, Name => Anastasia, Address => Via Quirinal Roma');

ret = G964.phone(dr, '19-421-674-8974');
console.log(ret == 'Phone => 19-421-674-8974, Name => C Powel, Address => Chateau des Fosses Strasbourg F-68000');

ret = G964.phone(dr, '1-921-512-2222');
console.log(ret == 'Phone => 1-921-512-2222, Name => Wilfrid Stevens, Address => Wild Street AA-67209');

ret = G964.phone(dr, '1-908-512-2222');
console.log(ret == "Phone => 1-908-512-2222, Name => Peter O'Brien, Address => High Street CC-47209");

ret = G964.phone(dr, '1-541-754-3010');
console.log(ret == 'Phone => 1-541-754-3010, Name => J Steeve, Address => 156 Alphand St.');
